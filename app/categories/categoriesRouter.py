...
def categories_create():
    ...
    return render_template('views/categories/forms/create.html', title='Crear Categorias', form=form)
...
def categories_update(id):
    ...
    return render_template('views/categories/forms/update.html', title='Actualizar Categorias', form=form, category_id=category.id)
